  ...
  return (
    ...
    >
      ...
      >
        ...
        <CustomIconButton
          onPress={onCameraClick ? onCameraClick : navigateToPath("/camera")}
        >
          <Box
            backgroundColor={isCameraPage ? "#AB97F9" : "#8DDC8B"}
            borderWidth='1px' borderColor="black" borderRadius="100" marginTop="-25px" marginLeft="42px" height="60px" width="60px"
          >
            <ImageBackground
              resizeMode="contain"
              style={{ position: "absolute", height: "100%", width: "100%" }}
